...
In western North America, the majority of eSTZs have been developed by just a couple of lab groups, whilst the remainder have largely been developed as one-off's by other assorted groups. 
...
Hence the dissemination of ideas during and after a restoration project is our best opportunity to increase the results of restorations, whether the format be verbal or written and shared via notes, or the grey and white literature (Figure 1). 
However, ideas have varying levels of complexity which may hinder their communication. 
For example seeding rates may be verbally communicated, while seed mixes are likely to require written documentation, while spatial data require both written and geographic data (e.g. coordinates and relations between them) in the form of spatial data products (e.g. rasters, shapefiles) to accurately convey their meaning. 
