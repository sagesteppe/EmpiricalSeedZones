...
Surprisingly, within each shapefile the field denoting the seed zones were often unlabeled, or entirely lacking any indication (Figure 3); in a number of instances it took us several minutes to determine which field was the seed zone by toggling through and visualizing many fields. 
...
This predictable nature will decrease the time required to find particular data attributes. 
